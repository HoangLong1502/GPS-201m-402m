...
exports.ResultsModule = ResultsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([result_entity_1.Result, user_entity_1.User]), auth_module_1.AuthModule],
        controllers: [results_controller_1.ResultsController],
        providers: [results_service_1.ResultsService, jwt_auth_guard_1.JwtAuthGuard],
    })
], ResultsModule);
