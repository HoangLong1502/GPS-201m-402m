...
let UsersController = class UsersController {
    ...
    create(createUserDto, avatar) {
        return this.usersService.create(createUserDto, avatar ? `/uploads/${avatar.filename}` : undefined);
    }
    findOne(id) {
        return this.usersService.findById(id);
    }
    update(id, updateUserDto, avatar) {
        return this.usersService.update(id, updateUserDto, avatar ? `/uploads/${avatar.filename}` : undefined);
    }
};
